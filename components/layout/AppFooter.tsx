...
const footerLinks = {
  calculators: [
    ...
    { label: "Auto Loan Calculator", href: "#auto" },
...
export function AppFooter() {
  return (
    <footer className="print:hidden border-t border-slate-200 bg-slate-50">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mb-4 text-sm leading-6 text-slate-600">
              Professional financial calculators and tools to help you make
              informed decisions. Fast, accurate, and free.
            </p>
        ...
        <div className="mt-12 border-t border-slate-200 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-sm text-slate-500">
              © {new Date().getFullYear()} FastCalculator. All rights reserved.
            </p>
            <p className="text-sm text-slate-500">
              <a
                href="https://fastcalculator.com"
